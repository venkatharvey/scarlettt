...
// Material Symbols 24px "note add" glyph — a document with a plus, used for
// importing a shared chat. Same family and viewBox as Newsstand beside it, so the
// two line up at the same optical weight in the sidebar.
export default function NoteAdd({ size, color }: NoteAddProps) {
    return (
